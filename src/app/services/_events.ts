...
export const EVENT_SERVICES: Record<EventService["key"], EventService> = {
  conference: {
    ...
    metaTitle: "컨퍼런스·세미나 대행 — 학술대회·포럼·심포지엄 기획 전문",
    metaDescription:
      "컨퍼런스·세미나 대행 전문 에이전시. 학술대회·세미나·심포지엄·국제 컨퍼런스·정책 포럼을 기획부터 운영까지 원스톱 대행. 하이브리드·동시통역 지원. KLS 국제학술대회 등 다수 실적. 무료 견적.",
    keywords: ["컨퍼런스대행", "세미나대행", "포럼대행", "학술대회대행", "행사대행", "컨퍼런스기획", "세미나기획", "심포지엄"],
  },
