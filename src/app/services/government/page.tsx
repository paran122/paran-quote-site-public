...
const faqJsonLd = {
  ...
  mainEntity: [
    ...
    { "@type": "Question", name: "공공기관 행사 대행 비용은 얼마인가요?", acceptedAnswer: { "@type": "Answer", text: "소규모 세미나(30~50명)는 약 800만 원부터, 중규모 포럼(100~200명)은 약 2,500만 원부터 시작합니다. 공공기관 예산 기준에 맞춰 산출내역서와 견적서를 제출합니다." } },
        ...
        <div className="mx-auto max-w-[900px] relative">
          ...
          <div className="mt-10 p-5 rounded-xl border border-blue-100 bg-blue-50/40">
            ...
            <p className="text-sm text-slate-600 leading-[1.8]">
              <span className="md:hidden">소규모 800만 원~, 중규모 2,500만 원~, 대규모 5,000만 원~. 1영업일 내 산출내역서 포함 견적 제공.</span>
              <span className="hidden md:inline">소규모 세미나(30~50명)는 약 800만 원부터, 중규모 포럼(100~200명)은
              약 2,500만 원부터, 대규모 국제행사(300명 이상)는 약 5,000만 원부터
          ...
          <ServiceFAQ
            items={[
              ...
              },
              {
                ...
                a: "소규모 세미나(30~50명)는 약 800만 원부터, 중규모 포럼(100~200명)은 약 2,500만 원부터 시작합니다. 공공기관 예산 기준에 맞춰 산출내역서와 견적서를 제출합니다. 정확한 비용은 행사 세부사항을 확인한 후 안내드립니다.",
              },
              {
