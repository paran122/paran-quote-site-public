      ...
      <section className="bg-[#091041] py-16 md:py-24 px-5 md:px-8">
        <div className="mx-auto max-w-[1000px]">
          ...
          <div className="grid gap-3 md:gap-4">
            {DESIGN_COMMON.painSolutions.map((ps, i) => (
        ...
        <div className="mx-auto max-w-[1000px]">
          ...
          <div className="grid sm:grid-cols-2 gap-3 md:gap-5">
            {group.items.map((item) => (
              <div key={item.anchor} id={item.anchor} className="scroll-mt-28 p-4 md:p-7 rounded-2xl bg-white border border-slate-200/80 shadow-sm hover:shadow-md transition-shadow">
                ...
                <p className="text-slate-600 text-[13px] md:text-sm leading-[1.65] mb-2 md:mb-3">{item.desc}</p>
                <p className="text-xs text-blue-700 bg-blue-50/70 rounded-lg px-3 py-1.5 md:py-2 inline-block mb-1.5 md:mb-2">{item.specs}</p>
        ...
        <div className="mx-auto max-w-[920px]">
          ...
          <div className="overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-[0_20px_60px_-30px_rgba(13,26,110,0.2)]">
            <div className="grid grid-cols-[0.8fr_1fr_1.1fr] md:grid-cols-[1.1fr_1fr_1fr] bg-[#091041] text-white text-[11px] md:text-sm font-bold">
              ...
              <div className="px-2.5 py-3 md:px-6 md:py-4 text-slate-300">일반 업체</div>
