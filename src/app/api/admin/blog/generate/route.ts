...
## 카테고리 (4개 중 1개 선택)
- 기획 가이드: 행사 기획 방법론, 대행사 선정, 기획서/견적서 작성법 등
- 현장 노하우: 큐시트, 체크리스트, MC 섭외, 만족도 조사, 제작물 가이드 등
- 행사 정보: 행사 유형 비교, 행사장 추천, 장비/비용 정보 등
- 행사 유형 가이드: 송년회, 시상식, 창립기념, 준공식, 워크숍, 체육대회 등 행사 종류별 A to Z
...

{
  ...
  "excerpt": "2~3문장 요약",
  "category": "기획 가이드 | 현장 노하우 | 행사 정보 | 행사 유형 가이드",
  "tags": ["태그1", "태그2", "태그3"],
