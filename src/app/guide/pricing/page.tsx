...
const jsonLd = {
  ...
  name: "행사 대행 비용·견적 안내",
  description:
    "세미나, 컨퍼런스, 포럼 등 행사 대행 비용의 항목별 가격 범위와 규모별 예산 설계 방법을 안내합니다. 소규모 800만 원부터 대규모 5,000만 원까지 투명한 견적을 제공합니다.",
  provider: {
    "@type": "Organization",
    name: "파란컴퍼니",
    url: SITE_URL,
  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        "@type": "Answer",
        text: "소규모 세미나(30~50명) 800만 원부터, 중규모 컨퍼런스(100~200명) 2,500만 원, 대규모 포럼·국제행사(300~500명) 5,000만 원부터 시작합니다. 행사 규모·장소·포함 항목에 따라 달라지며, 상담 후 투명하게 견적을 안내드립니다.",
      },
    },
    {
      "@type": "Question",
