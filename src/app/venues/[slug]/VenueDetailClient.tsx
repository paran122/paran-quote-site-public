        ...
        <div className="fixed inset-0 z-[120] flex items-center justify-center bg-slate-950/70 p-3 backdrop-blur-sm sm:p-6" onClick={close}>
          ...
          >
            <div className="flex items-center justify-between gap-3 px-4 py-3 text-white">
              <span className="min-w-0 flex-1 truncate text-[13px] font-medium">{gallery[lbIdx].caption ?? v.name}</span>
            ...
            >
              {/* eslint-disable-next-line @next/next/no-img-element */}
              <img src={gallery[lbIdx].url} alt={gallery[lbIdx].caption ?? v.name} className="max-h-[64vh] max-w-full object-contain" />
              {gallery.length > 1 && (
                <>
