            ...
            <div className="grid grid-cols-3 gap-3 md:gap-4">
              {CERTS.map((c) => (
                ...
                >
                  ...
                  <p className="mt-2 text-center text-[10.5px] font-semibold leading-snug text-white md:mt-2.5 md:text-[12px]">{c.name}</p>
                  <p className="mt-0.5 hidden text-center text-[10px] leading-snug text-slate-400 md:block">{c.sub}</p>
                </button>
              ))}
            </div>
