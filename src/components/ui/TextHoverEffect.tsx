    ...
    >
      <defs>
        ...
        >
          ...
          <stop offset="70%" stopColor={hovered ? "grey" : "black"} />
      ...
      {/* Ghost stroke - always slightly visible */}
      <text
        x="50%"
        y="50%"
        textAnchor="middle"
      ...
      <motion.text
        ...
        strokeWidth="0.3"
        className="fill-transparent font-[helvetica] text-7xl font-bold"
        style={{ stroke: "rgba(99, 102, 241, 0.3)" }}
      ...
      {/* Color reveal on hover - uses mask */}
      <text
        x="50%"
        y="50%"
        textAnchor="middle"
